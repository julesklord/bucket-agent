...
use super::super::BucketAuth;
use super::protocol::{OidcError, OidcUserInfo, build_bucket_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &BucketAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_bucket_auth(tokens, user_info, issuer, client_id);
