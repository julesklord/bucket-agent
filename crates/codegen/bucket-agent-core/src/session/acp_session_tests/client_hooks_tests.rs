            ...
            *actor.client_hooks.borrow_mut() = client_hooks;
            ...
            tokio::task::spawn_local(async move {
                while let Some(msg) = gateway_rx.recv().await {
                    match msg {
                        bucket_acp::AcpClientMessage::ExtMethod(args) => {
                        ...
                        bucket_acp::AcpClientMessage::SessionNotification(args) => {
        ...
        .run_until(async {
            ...
            *actor.agent.borrow_mut() =
            ...
            client_hooks.insert(
                ...
                vec![crate::extensions::hooks::ClientHookGroup {
                    matcher: Some(
                        bucket_hooks::matcher::HookMatcher::new("linear__save_issue").unwrap(),
                    ),
                    callback_ids: vec!["cb_0".to_string()],
                    timeout: None,
                }],
...
async fn post_tool_use_and_failure_never_double_fire() {
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_bucket_build_agent_with_todo().await;
