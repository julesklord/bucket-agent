...
impl bucket_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> bucket_tool_protocol::ToolId {
        bucket_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                bucket_tool_runtime::ToolError::execution(
                    bucket_tool_protocol::ToolId::new("memory_search").expect("valid"),
