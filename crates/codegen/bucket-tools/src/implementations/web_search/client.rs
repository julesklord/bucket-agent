...
impl WebSearchClient {
    ...
    pub async fn search(
    ...
    ) -> Result<(String, Vec<String>), bucket_tool_runtime::ToolError> {
        ...
        if status == reqwest::StatusCode::UNAUTHORIZED {
            ...
            return Err(bucket_tool_runtime::ToolError::unauthorized(format!(
    ...
    pub async fn search_with_titles(
        ...
        query: &str,
        allowed_domains: Option<Vec<String>>,
    ) -> Result<(String, Vec<(String, String)>), bucket_tool_runtime::ToolError> {
        let web_search = rs::WebSearchToolArgs::default()
            .filters(rs::WebSearchToolFilters { allowed_domains })
            .build()
            .map_err(|e| {
