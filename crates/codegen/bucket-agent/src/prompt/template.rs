...
/// The base prompt template source, exposed for `bucket prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `bucket prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard bucket-build tool kinds.
