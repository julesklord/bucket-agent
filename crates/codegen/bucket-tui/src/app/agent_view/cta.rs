...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        bucket_telemetry::session_ctx::log_event(bucket_telemetry::events::PromptSuggestion {
            action: bucket_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        bucket_telemetry::session_ctx::log_event(
            bucket_telemetry::events::PluginCtaConnectClicked {
...
mod plugin_cta_notify_tests {
    ...
    fn cta_entry(name: &str) -> bucket_hooks_plugins_types::MarketplacePluginEntry {
