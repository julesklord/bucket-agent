...
const ENV_THREADS: &str = "BUCKET_GIX_STATUS_THREADS";
...
/// Production budget (`n >= 1`). Honours `BUCKET_GIX_STATUS_THREADS=N` for `N >= 1`
...
mod nproc_tests {
    ...
    const CHILD_ENV: &str = "BUCKET_GIX_STATUS_NPROC_CHILD";
    const REPO_ENV: &str = "BUCKET_GIX_STATUS_NPROC_REPO";
