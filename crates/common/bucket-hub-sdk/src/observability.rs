...
use bucket_tool_protocol::{SessionId, session_event::SessionEvent};
...
mod tests {
    use super::*;
    use bucket_tool_protocol::session_event::{SessionEvent, SessionPhase, ToolCallOutcome};
    ...
    fn session_event_serializes_to_expected_json() {
        ...
        assert_eq!(value["model_id"], "bucket-3");
