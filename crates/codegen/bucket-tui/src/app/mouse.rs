            ...
            MouseEventKind::Down(MouseButton::Left) => {
                    ...
                    && !self.pos_occluded(mouse.column, mouse.row)
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        bucket_telemetry::events::AnnouncementCtaSurface::Banner,
                    ));
                }
                if self
                    .plugin_cta
                        ...
                        &self.plugin_cta.phase
                {
                    ...
                    bucket_telemetry::session_ctx::log_event(
                        bucket_telemetry::events::PluginCtaDismissed {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        bucket_telemetry::events::AnnouncementCtaSurface::Header,
                    ));
                }
                        ...
                        if let Some(idx) = hit_idx {
                                    ...
                                    .entry_screen_area(idx, self.pane_areas.scrollback)
                            {
                                ...
                                if click_row >= url_row {
                                    ...
                                    bucket_telemetry::session_ctx::log_event(bucket_telemetry::events::CreditLimitUpsellClicked {
