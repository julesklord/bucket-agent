...
impl bucket_tool_runtime::ToolOutput for SchedulerDeleteOutput {}
...
impl bucket_tool_runtime::Tool for SchedulerDeleteTool {
    type Args = SchedulerDeleteInput;
    type Output = SchedulerDeleteOutput;

    fn id(&self) -> bucket_tool_protocol::ToolId {
        bucket_tool_protocol::ToolId::new("scheduler_delete").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerDeleteOutput, bucket_tool_runtime::ToolError> {
