...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<bucket_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(bucket_tools::implementations::bucket_build::update_goal::UpdateGoalInput),
    Channel(bucket_tools::implementations::bucket_build::update_goal::UpdateGoalEnvelope),
}
