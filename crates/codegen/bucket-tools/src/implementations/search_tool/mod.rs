...
impl bucket_tool_runtime::Tool for SearchTool {
    type Args = SearchToolInput;
    type Output = ToolOutput;

    fn id(&self) -> bucket_tool_protocol::ToolId {
        bucket_tool_protocol::ToolId::new("search_tool").expect("valid tool id")
    }
...
mod tests {
    ...
    fn hash_value_pinned_output() {
        ...
        let h = hash_value(&"bucket-mcp-fingerprint-stability-test");
        assert_eq!(h, hash_value(&"bucket-mcp-fingerprint-stability-test"));
