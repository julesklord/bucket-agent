...
impl bucket_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl crate::types::tool_metadata::ToolMetadata for SchedulerListTool {
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        Expr::Value(ToolRequirement::Tool {
            ...
            id: bucket_tool_runtime::Tool::id(&SchedulerCreateTool).to_string(),
            if_params: None,
        })
    }
}

impl bucket_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> bucket_tool_protocol::ToolId {
        bucket_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, bucket_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                bucket_tool_runtime::ToolError::execution(
                    bucket_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
