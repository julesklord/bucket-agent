...
pub mod detection {
    pub use bucket_file_utils::workspace_classifier::is_project_dir;
}
pub mod sources;
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run Bucket Build in a project directory?\n\n\
                 This gives Bucket Build full context of your codebase for better results."
                .into(),
            id: None,
            options,
