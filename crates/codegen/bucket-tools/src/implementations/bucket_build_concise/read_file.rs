...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::BucketBuildConcise
    }
...
impl bucket_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // BucketBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::bucket_build::read_file::ReadFileTool;
