//! Shared helpers for bucket-agent-core integration tests.

use bucket_agent_core::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `bucket_sampler::SamplingClient`, which takes a
