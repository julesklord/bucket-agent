...
//! cargo test -p bucket-tools --test cgroup_memory_test -- --ignored --nocapture
//!
//! # If you need root:
//! sudo -E cargo test -p bucket-tools --test cgroup_memory_test -- --ignored --nocapture
//! ```
//!
...
use bucket_tools::computer::local::cgroup::{CgroupMemoryConfig, PROCESS_OOM_EXIT_CODE};
use bucket_tools::computer::types::{TerminalBackend, TerminalRunRequest, TerminalRunResult};
