...
//! string/text manipulation. Harness-bound extraction (Bucket chat's
//! `BucketConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `BucketMessage` assembly) stays in the harness crate.
