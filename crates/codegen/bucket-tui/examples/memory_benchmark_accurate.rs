...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "bucket-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "bucket-3", "researcher");
    ...
    let shared_models = ["bucket-3", "bucket-3-mini"];
