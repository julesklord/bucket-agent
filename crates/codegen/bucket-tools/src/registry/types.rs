...
/// this crate: instead of `bucket-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
impl ToolConfig {
    ...
    /// `bucket_tool_runtime::Tool::id()`. Use this for built-in tools known
    ...
    where
        T: crate::types::tool_metadata::ToolMetadata + bucket_tool_runtime::Tool + Default,
    {
        Self::from(&T::default())
    }
...
impl<T: crate::types::tool_metadata::ToolMetadata + bucket_tool_runtime::Tool> From<&T>
    for ToolConfig
{
    fn from(tool: &T) -> Self {
        Self {
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::bucket_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::bucket_build::web_fetch::WebFetchConfig,
    ...
    pub image_gen_config: crate::implementations::bucket_build::image_gen::ImageGenConfig,
    ...
    pub video_gen_config: crate::implementations::bucket_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::bucket_build::deploy_app::AppBuilderDeployerConfig,
    ...
    /// Auth provider which returns a bucket_hub_sdk::AuthCredential. Can be used by
    ...
    pub auth_provider: Option<bucket_hub_sdk::SharedAuthProvider>,
...
pub async fn drain_value_stream(
    mut stream: bucket_tool_runtime::ToolStream<bucket_tool_runtime::TypedToolOutput>,
) -> Result<serde_json::Value, bucket_tool_runtime::ToolError> {
    use futures::StreamExt;
    while let Some(item) = stream.next().await {
        match item {
            bucket_tool_runtime::ToolStreamItem::Progress(_) => continue,
            bucket_tool_runtime::ToolStreamItem::Terminal(result) => {
...
fn stream_no_terminal_error() -> bucket_tool_runtime::ToolError {
...
struct DispatchParts {
    ...
    lr_handle: Arc<dyn bucket_hub_core::ToolHandle>,
...
struct ToolEntry {
    ...
    register_in_local: Box<dyn Fn(&bucket_hub_sdk::LocalRegistry) + Send + Sync>,
}
...
pub struct FinalizedToolset {
    ...
    local_registry: bucket_hub_sdk::LocalRegistry,
    ...
    workspace_viewer_ctx: Option<bucket_tool_runtime::WorkspaceViewerContext>,
}
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
...
pub struct ToolRegistryBuilder {
    ...
    shared_local_registry: Option<bucket_hub_sdk::LocalRegistry>,
}
...
impl ToolRegistryBuilder {
            ...
            + 'static,
    {
        ...
        let id = bucket_tool_runtime::Tool::id(&tool).as_str().to_string();
        let kind = tool.kind();
        ...
        self.tools.insert(
            ...
            ToolEntry {
                ...
                register_in_local: Box::new(|lr: &bucket_hub_sdk::LocalRegistry| {
    ...
    /// Fully-qualified tool id (`"BucketBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<bucket_build::BashTool, bucket_build::bash::BashParams>();
        b.register_with_params::<bucket_build::ReadFileTool, bucket_build::read_file::ReadFileParams>();
        ...
        b.register::<bucket_build::TodoWriteTool>();
        b.register::<bucket_build::UpdateGoalTool>();
        b.register::<bucket_build::TaskOutputTool>();
        b.register::<bucket_build::GetTerminalCommandOutputTool>();
        b.register::<bucket_build::WaitTasksTool>();
        b.register::<bucket_build::TaskTool>();
        b.register::<bucket_build::WebSearchTool>();
        b.register_with_params::<bucket_build::WebFetchTool, bucket_build::web_fetch::WebFetchParams>();
        b.register::<bucket_build::LspTool>();
        b.register::<bucket_build::ImageGenTool>();
        b.register::<bucket_build::ImageEditTool>();
        b.register::<bucket_build::ImageToVideoTool>();
        b.register::<bucket_build::ReferenceToVideoTool>();
        b.register::<bucket_build::EnterPlanModeTool>();
        b.register::<bucket_build::ExitPlanModeTool>();
        b.register_with_params::<
                bucket_build::AskUserQuestionTool,
                bucket_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<bucket_build::MonitorTool>();
        b.register::<bucket_build::SchedulerCreateTool>();
        b.register::<bucket_build::SchedulerDeleteTool>();
        b.register::<bucket_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                bucket_build_concise::ReadFileConciseTool,
                bucket_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                bucket_build_concise::SearchReplaceConciseTool,
                bucket_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                bucket_build_concise::BashConciseTool,
                bucket_build::bash::BashParams,
            >();
        b.register_with_params::<
                bucket_build_hashline::HashlineReadTool,
                bucket_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                bucket_build_hashline::HashlineEditTool,
                bucket_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                bucket_build_hashline::HashlineGrepTool,
                bucket_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn with_local_registry(mut self, registry: bucket_hub_sdk::LocalRegistry) -> Self {
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            let standard_file_ids: &[&str] = &[
                "BucketBuild:read_file",
                "BucketBuild:search_replace",
                "BucketBuild:grep",
            ];
            let hashline_file_ids: &[&str] = &[
                "BucketBuildHashline:hashline_read",
                "BucketBuildHashline:hashline_edit",
                "BucketBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if ctx.image_gen_config.has_credentials() {
            match crate::implementations::bucket_build::image_gen::ImageGenClient::new(
        ...
        if ctx.video_gen_config.is_enabled() {
            match crate::implementations::bucket_build::video_gen::VideoGenClient::new(
        ...
        if let crate::implementations::bucket_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::bucket_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::BucketBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::bucket_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::bucket_build::scheduler::types::SchedulerState>(
            );
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::bucket_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::bucket_build::scheduler::actor::SchedulerActor {
...
///
/// Implements the canonical `bucket_tool_runtime::ToolDispatch` trait so the
...
#[async_trait::async_trait]
impl bucket_tool_runtime::ToolDispatch for InnerDispatchForToolset {
    async fn call(
        &self,
        ...
        let result = self
            ...
            .and_then(|output| {
                let value = serde_json::to_value(&output).map_err(|e| {
                    bucket_tool_runtime::ToolError::custom("output_encoding", e.to_string())
                })?;
                Ok(bucket_tool_runtime::TypedToolOutput::from_value(
                    tool_id.clone(),
                    value,
                ))
            });
        bucket_tool_runtime::terminal_only(result)
    }
}
impl FinalizedToolset {
    ...
    pub fn empty_for_test() -> Self {
        Self {
            ...
            local_registry: bucket_hub_sdk::LocalRegistry::new(),
    ...
    pub fn local_registry(&self) -> &bucket_hub_sdk::LocalRegistry {
        &self.local_registry
    }
    ...
    fn tool_not_found_error(tool_name: &str) -> bucket_tool_runtime::ToolError {
        let tid = bucket_tool_protocol::ToolId::new(tool_name)
            .unwrap_or_else(|_| bucket_tool_protocol::ToolId::new("unknown").expect("valid"));
        bucket_tool_runtime::ToolError::not_found(tid, format!("Tool not found: {tool_name}"))
    }
    pub async fn try_parse(
        &self,
        tool_name: &str,
        tool_params: &serde_json::Value,
    ) -> Result<ToolInput, bucket_tool_runtime::ToolError> {
    ...
    async fn call_raw(
        ...
        parent_ctx: bucket_tool_runtime::ToolCallContext,
    ) -> Result<crate::types::output::ToolOutput, bucket_tool_runtime::ToolError> {
        ...
        let mut ctx = bucket_tool_runtime::ToolCallContext::new(parent_ctx.call_id.clone());
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        if let Some(cwd) = parent_ctx.extensions.get::<bucket_tool_runtime::Cwd>() {
            ctx.extensions.insert((*cwd).clone());
        }
        let tool_id = bucket_tool_protocol::ToolId::new(&registry_id)
            .unwrap_or_else(|_| bucket_tool_protocol::ToolId::new("unknown").expect("valid"));
        let lr_handle = self.local_registry.find(&tool_id).ok_or_else(|| {
            bucket_tool_runtime::ToolError::not_found(
                tool_id,
    ...
    pub async fn call(
        ...
        while let Some(item) = stream.next().await {
            match item {
                bucket_tool_runtime::ToolStreamItem::Progress(_) => continue,
                bucket_tool_runtime::ToolStreamItem::Terminal(result) => return result,
            }
        }
        Err(stream_no_terminal_error())
    }
    ...
    ///
    /// [`ToolStream`]: bucket_tool_runtime::ToolStream
    /// [`ToolStreamItem::Progress`]: bucket_tool_runtime::ToolStreamItem::Progress
    pub fn call_streaming(
        ...
        tool_call_id: &str,
        cwd_override: Option<std::path::PathBuf>,
    ) -> bucket_tool_runtime::ToolStream<ToolRunResult> {
        use futures::StreamExt;
        ...
        Box::pin(async_stream::stream! {
            ...
            bucket_tool_runtime::ToolStreamItem::Terminal(Err(e)); return; } }; let
            ...
            match item { bucket_tool_runtime::ToolStreamItem::Progress(p) => { yield
            bucket_tool_runtime::ToolStreamItem::Progress(p); }
            bucket_tool_runtime::ToolStreamItem::Terminal(Err(e)) => { yield
            bucket_tool_runtime::ToolStreamItem::Terminal(Err(e)); return; }
            bucket_tool_runtime::ToolStreamItem::Terminal(Ok(typed)) => { let run_result
            = this.finalize_output(typed.value, & output_converter,
            effective_tool_name). await; yield
            bucket_tool_runtime::ToolStreamItem::Terminal(run_result); return; } } }
            yield
            bucket_tool_runtime::ToolStreamItem::Terminal(Err(stream_no_terminal_error()));
        })
    }
    ...
    fn prepare_dispatch(
        ...
        tool_call_id: &str,
        cwd_override: Option<std::path::PathBuf>,
    ) -> Result<DispatchParts, bucket_tool_runtime::ToolError> {
        let (registry_id, output_converter, reverse_params) = {
            let tools = self.tools.read();
            let entry = tools
                .iter()
        ...
        let rt_call_id = bucket_tool_protocol::ToolCallId::new(tool_call_id)
            .unwrap_or_else(|_| bucket_tool_protocol::ToolCallId::new_v7());
        let mut ctx = bucket_tool_runtime::ToolCallContext::new(rt_call_id);
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        if let Some(cwd) = cwd_override {
            ctx.extensions.insert(bucket_tool_runtime::Cwd(cwd));
        }
        if let Some(ref version) = contract_version {
            ctx.extensions
                .insert(bucket_tool_runtime::BehaviorVersion(version.clone()));
        }
    ...
    ///
    /// The tool must implement `bucket_tool_runtime::Tool + ToolMetadata`.
    ...
    ) -> Result<(), bucket_tool_runtime::ToolError>
    where
        T: bucket_tool_runtime::Tool + ToolMetadata + std::fmt::Debug + Send + Sync + 'static,
        T::Output: serde::Serialize,
    {
        let mut tools = self.tools.write();
        if tools.iter().any(|t| t.client_name == name) {
            return Err(bucket_tool_runtime::ToolError::invalid_arguments(format!(
                "Tool already registered: {name}"
            )));
        }
        let description = tool.description_template().to_string();
        let kind = tool.kind();
        let registry_id = bucket_tool_runtime::Tool::id(&tool).as_str().to_owned();
    ...
    pub fn unregister_tools_by_prefix(&self, prefix: &str) -> usize {
        ...
        let to_remove: Vec<_> = tools
            ...
            .filter_map(|t| bucket_tool_protocol::ToolId::new(&t.registry_id).ok())
            .collect();
    ...
    pub fn unregister_tool_by_name(&self, name: &str) -> bool {
        ...
        let tool_id = tools
            ...
            .and_then(|t| bucket_tool_protocol::ToolId::new(&t.registry_id).ok());
        let before = tools.len();
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "BucketBuild:get_task_output" => {
            let has_bucket_build_bash = has_tool_with_bool_param(
                proposed,
                "BucketBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_bucket_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "BucketBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "BucketBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "BucketBuild", "run_terminal_cmd")
                && !has_bucket_build_bash
            {
                notes
                    .push(
                        "BucketBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "BucketBuildConcise", "run_terminal_cmd")
                && !has_bucket_build_concise_bash
            {
                notes
                    .push(
                        "BucketBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (BucketBuild:run_terminal_cmd or BucketBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or BucketBuild:task"
                .to_string();
            let has_provider = has_bucket_build_bash || has_bucket_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or BucketBuild:task",
                )
                .with_category("requirements")
        }
        "BucketBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as BucketBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "BucketBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires BucketBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include BucketBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "BucketBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires BucketBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include BucketBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::bucket_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
                crate::implementations::bucket_build::image_gen::ImageGenConfig::default(),
            video_gen_config:
    ...
    /// appeared before `bucket_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "BucketBuild:search_replace".to_string(),
                    params: Some(
                        serde_json::json!({
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "BucketBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full BucketBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::bucket_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("BucketBuild:{id}")))
            .collect(),
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    /// name: `run_terminal_cmd` (bucket).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let bucket = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("BucketBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("BucketBuild:get_task_output".to_string()),
                        ToolConfig::from_id("BucketBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("bucket toolset should finalize");
        assert_eq!(
            bucket.tool_name_for_kind(ToolKind::Execute).as_deref(),
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({ "id" : "BucketBuild:read_file", "kind" : "read" }));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({ "id" : "BucketBuild:read_file", "kind" : "raed" }));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({ "id" : "BucketBuild:read_file" }));
    ...
    /// Verify BucketBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "BucketBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "BucketBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "BucketBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<bucket_build::GrepTool>(),
                ToolConfig::for_tool::<bucket_build::KillTaskTool>(),
                ToolConfig::for_tool::<bucket_build::TaskOutputTool>(),
                ToolConfig {
                    id: "BucketBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        let builder = ToolRegistryBuilder::new();
        for id in [
            "BucketBuild:run_terminal_cmd",
            "BucketBuild:read_file",
            "BucketBuild:search_replace",
            "BucketBuild:list_dir",
            "BucketBuild:grep",
            "BucketBuild:get_terminal_command_output",
            "BucketBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("BucketBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("BucketBuild:run_terminal_cmd", ToolKind::Execute),
            ("BucketBuild:read_file", ToolKind::Read),
            ("BucketBuild:search_replace", ToolKind::Edit),
            ("BucketBuild:grep", ToolKind::Search),
            ("BucketBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("BucketBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `BucketBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "BucketBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "BucketBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "BucketBuildHashline:hashline_read".to_string(),
                params: Some(
    ...
    impl bucket_tool_runtime::Tool for FakeMcpTool {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> bucket_tool_protocol::ToolId {
            bucket_tool_protocol::ToolId::new("fake_mcp").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::bucket_tool_runtime::ListToolsContext,
        ) -> bucket_tool_types::ToolDescription {
            bucket_tool_types::ToolDescription::new("fake_mcp", &self.description)
        }
        async fn run(
            &self,
            _ctx: bucket_tool_runtime::ToolCallContext,
            _input: serde_json::Value,
        ) -> Result<String, bucket_tool_runtime::ToolError> {
            Ok("ok".into())
        }
    }
    #[tokio::test]
    ...
    impl bucket_tool_runtime::Tool for NonStreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> bucket_tool_protocol::ToolId {
            bucket_tool_protocol::ToolId::new("non_streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::bucket_tool_runtime::ListToolsContext,
        ) -> bucket_tool_types::ToolDescription {
            bucket_tool_types::ToolDescription::new("non_streaming_stub", "non-streaming stub")
        }
        async fn run(
            &self,
            _ctx: bucket_tool_runtime::ToolCallContext,
    ...
    impl bucket_tool_runtime::Tool for StreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> bucket_tool_protocol::ToolId {
            bucket_tool_protocol::ToolId::new("streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::bucket_tool_runtime::ListToolsContext,
        ) -> bucket_tool_types::ToolDescription {
            bucket_tool_types::ToolDescription::new("streaming_stub", "streaming stub")
        }
        async fn run(
            &self,
            _ctx: bucket_tool_runtime::ToolCallContext,
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<bucket_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
        ...
        while let Some(item) = stream.next().await {
            match item {
                bucket_tool_runtime::ToolStreamItem::Progress(p) => {
                    ...
                    assert!(matches!(p, bucket_tool_runtime::ToolProgress::Text { .. }));
                    progress_count += 1;
                }
                bucket_tool_runtime::ToolStreamItem::Terminal(result) => {
    ...
    impl bucket_tool_runtime::Tool for NoTerminalStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> bucket_tool_protocol::ToolId {
            bucket_tool_protocol::ToolId::new("no_terminal_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::bucket_tool_runtime::ListToolsContext,
        ) -> bucket_tool_types::ToolDescription {
            bucket_tool_types::ToolDescription::new("no_terminal_stub", "no-terminal stub")
        }
        async fn run(
            &self,
            _ctx: bucket_tool_runtime::ToolCallContext,
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<bucket_build::ReadFileTool>(),
                ToolConfig::for_tool::<bucket_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        assert!(
            errors.iter().any(|e| e.tool == "BucketBuild:task"
                ...
                && e.message.contains("BucketBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "BucketBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "BucketBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// bucket-build agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("BucketBuild:run_terminal_cmd"),
                tool("BucketBuild:task"),
                tool("BucketBuild:get_task_output"),
                tool("BucketBuild:wait_tasks"),
                tool("BucketBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("BucketBuild:get_task_output"));
        assert!(error.message.contains("BucketBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "BucketBuild:task");
        assert!(error.message.contains("BucketBuild:get_task_output"));
        assert!(error.message.contains("BucketBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "BucketBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "BucketBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "BucketBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default bucket-build tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("BucketBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("BucketBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("BucketBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("BucketBuildHashline:hashline_read"),
                hashline_tool_config("BucketBuildHashline:hashline_edit"),
                hashline_tool_config("BucketBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("BucketBuild:read_file"),
                hashline_tool_config("BucketBuild:search_replace"),
                hashline_tool_config("BucketBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<bucket_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<bucket_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "BucketBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<bucket_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<bucket_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<bucket_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "BucketBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background" : true })
                    .as_object()
                    .unwrap()
    ...
    async fn bucket_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<bucket_build::ListDirTool>(),
                ToolConfig::for_tool::<bucket_build::ReadFileTool>(),
                ToolConfig::for_tool::<bucket_build::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<bucket_build::TaskOutputTool>(),
                ToolConfig::for_tool::<bucket_build::KillTaskTool>(),
                ToolConfig::for_tool::<bucket_build::GrepTool>(),
                ToolConfig::for_tool::<bucket_build::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = bucket_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = bucket_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<bucket_build::ListDirTool>()],
            behavior_preset: None,
        };
    ...
    async fn prepare_dispatch_stamps_workspace_viewer_ctx_when_present() {
        let (toolset, _tmp) =
            toolset_with_viewer_ctx(Some(bucket_tool_runtime::WorkspaceViewerContext {
        ...
        let wvc = parts
            .ctx
            .extensions
            .get::<bucket_tool_runtime::WorkspaceViewerContext>()
    ...
    async fn bash_streaming_progress_emitted_via_finalized_toolset_when_gate_on() {
        ...
        while let Some(item) = stream.next().await {
            match item {
                bucket_tool_runtime::ToolStreamItem::Progress(_) => progress_count += 1,
                bucket_tool_runtime::ToolStreamItem::Terminal(r) => {
