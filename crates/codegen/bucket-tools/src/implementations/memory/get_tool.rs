...
impl bucket_tool_runtime::Tool for MemoryGetImpl {
    type Args = MemoryGetInput;
    type Output = ToolOutput;

    fn id(&self) -> bucket_tool_protocol::ToolId {
        bucket_tool_protocol::ToolId::new("memory_get").expect("valid tool id")
    }
        ...
        let content = memory
            ...
            .map_err(|e| {
                bucket_tool_runtime::ToolError::execution(
                    bucket_tool_protocol::ToolId::new("memory_get").expect("valid"),
