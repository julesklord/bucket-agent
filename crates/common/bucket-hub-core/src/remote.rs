...
fn map_block(block: bucket_tool_protocol::McpBlock) -> ContentBlock {
    use bucket_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: bucket_tool_protocol::JsonRpcError) -> ToolError {
