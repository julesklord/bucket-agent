...
const THEME_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "bucketnight",
        display: "Bucket Night",
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain bucket in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain bucket in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `bucket_voice::STT_LANGUAGES` (official Bucket STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain bucket opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "bucketnight".
                default: "bucketnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "bucketnight".
                default: "bucketnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "bucketday".
                default: "bucketday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "bucket", "switch"],
        ...
        // The `BUCKET_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // follows the process locale when it maps to a Bucket STT language.
        // Catalog = official STT languages (see bucket_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Bucket STT). \
