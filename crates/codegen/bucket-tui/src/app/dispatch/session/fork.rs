...
-> [bucket_tools::implementations::bucket_build::ask_user_question::QuestionOption; 2] {
    use bucket_tools::implementations::bucket_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
