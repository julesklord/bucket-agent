...
// minimal rendering lives in the sibling `bucket-tui-minimal` crate; these
...
// `bucket-tui-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use bucket_tui_render::{
