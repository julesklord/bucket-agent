//! bucket-sampler - Actor-based sampling layer for xAI bucket.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `bucket-agent-core`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `bucket-hunk-tracker`.
//!
//! ## Layered API
//!
