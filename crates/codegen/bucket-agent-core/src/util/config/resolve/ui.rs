...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "BUCKET_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`BUCKET_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "BUCKET_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`BUCKET_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "BUCKET_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`BUCKET_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `BUCKET_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("BUCKET_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes BUCKET_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
