...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&BucketAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> bucket_telemetry::events::AuthTokenKind {
        use bucket_telemetry::events::AuthTokenKind as K;
        match self {
