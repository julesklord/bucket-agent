...
use crate::implementations::bucket_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::bucket_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::bucket_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::bucket_build::grep::GrepSearchInput;
use crate::implementations::bucket_build::image_edit::ImageEditInput;
use crate::implementations::bucket_build::image_gen::ImageGenInput;
use crate::implementations::bucket_build::list_dir::ListDirInput;
use crate::implementations::bucket_build::read_file::ReadFileInput;
use crate::implementations::bucket_build::search_replace::SearchReplaceInput;
use crate::implementations::bucket_build::todo::TodoWriteInput;
use crate::implementations::bucket_build::update_goal::UpdateGoalInput;
use crate::implementations::bucket_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::bucket_build::web_fetch::WebFetchInput;
use crate::implementations::bucket_build::web_search::WebSearchInput;
...
use bucket_tool_types::KillTaskToolInput;
use bucket_tool_types::TaskOutputToolInput;
use bucket_tool_types::TaskToolInput;
use bucket_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::bucket_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::bucket_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::bucket_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::bucket_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::bucket_build::scheduler::list::SchedulerListInput),
