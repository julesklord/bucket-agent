...
//!
//! Security: the subprocess is spawned with [`bucket_tty_utils::detach_std_command`]
//! (TTY/session detach) + [`bucket_tty_utils::pager_env`] + null stdio, source is
