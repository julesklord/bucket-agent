...
pub enum LogSource {
    ...
    #[serde(rename = "shell")]
    Shell,
    #[strum(serialize = "bucket-pager")]
    #[serde(rename = "bucket-pager")]
    BucketPager,
    #[strum(serialize = "bucket-desktop")]
    #[serde(rename = "bucket-desktop")]
    BucketDesktop,
}
...
fn log_path() -> PathBuf {
    bucket_home().join(LOG_DIR).join(LOG_FILE)
}
