//! bucket-build compaction configuration.
//!
...
/// bucket-build and Bucket chat (~85% trigger on both sides).
pub const DEFAULT_AUTO_COMPACT_THRESHOLD_PERCENT: u8 = 85;

/// Minimum character count for a cleaned summary seed.
///
/// bucket-build retries when the cleaned summary is shorter than this — the
