...
| `GROK_HOME`                    | Override config directory (default: `~/.bucket`)                |
...
Grok stores data in `~/.bucket` (override with `GROK_HOME`; see [Environment Variables for Headless](#environment-variables-for-headless)):
