...
//! cargo build --release -p bucket-shared --example clipboard_probe
//! hyperfine --warmup 2 \
//!   -n native './target/release/examples/clipboard_probe' \
//!   -n osascript 'BUCKET_CLIPBOARD_NO_NATIVE_READ=1 ./target/release/examples/clipboard_probe'
//! ```
//!
...
fn main() -> anyhow::Result<()> {
    ...
    let attachments = bucket_shared::clipboard::get_attachments()?;
