...
use bucket_acp::AcpClientMessage;

use super::actions::Effect;
use bucket_agent_core::extensions::notification::{
    SessionNotification, SessionUpdate as XaiSessionUpdate, is_reauthable_failure,
};
use bucket_agent_core::tools::todo::todo_item_from_plan_entry;
use bucket_workspace::permission::bash_command_splitting::BashCommandHighlights;
...
fn handle_ext_method(ext: bucket_acp::AcpArgs<acp::ExtRequest>, app: &mut AppView) -> bool {
