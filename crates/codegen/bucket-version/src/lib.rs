//! Installed bucket CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "BUCKET_TEST_VERSION";

pub const VERSION: &str = match option_env!("BUCKET_VERSION") {
    Some(v) => v,
