...
fn ok_result(text: &str) -> Result<ToolRunResult, bucket_tool_runtime::ToolError> {
    Ok(ToolRunResult {
...
fn err(msg: &str) -> Result<ToolRunResult, bucket_tool_runtime::ToolError> {
...
fn is_auth_tool_error_classification() {
    ...
    let cases: Vec<(bool, bucket_tool_runtime::ToolError)> = vec![
        ...
        (
            true,
            bucket_tool_runtime::ToolError::new(
                bucket_tool_runtime::ToolErrorKind::Custom,
        ...
        // the inference path's gate in bucket-sampling-types/src/error.rs:
        ...
        (
            true,
            bucket_tool_runtime::ToolError::invalid_arguments(r#"{"error":"invalid_token"}"#),
        ),
        // Fallback path: case-insensitive "unauthorized" anywhere in
        // the message body.
        (
            true,
            bucket_tool_runtime::ToolError::invalid_arguments("UNAUTHORIZED"),
        ),
        ...
        (
            ...
            bucket_tool_runtime::ToolError::not_found(
                bucket_tool_protocol::ToolId::new("image_gen").expect("valid"),
        ...
        (
            false,
            bucket_tool_runtime::ToolError::invalid_arguments("request id req_401abc failed"),
        ),
    ];
