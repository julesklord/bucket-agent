...
const HERO_SUBTITLE: &str = "Thanks for trying Bucket Agent, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&bucket_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn ann(title: Option<&str>, message: Option<&str>) -> bucket_announcements::RemoteAnnouncement {
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Bucket 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Bucket 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(bucket_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/bucket".into()),
        ...
        let mut dismissible = ann(None, Some("Bucket 4.5 is here. Upgrade now."));
        dismissible.cta = Some(bucket_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/bucket".into()),
            caption: Some("or use Ctrl+O".into()),
        });
