...
//!
//! Reuses the core file-reading logic from [`bucket_build::read_file::run_read_file`]
...
use crate::implementations::bucket_build::read_file::{ReadFileInput, run_read_file};
...
impl bucket_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> bucket_tool_protocol::ToolId {
        bucket_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::bucket_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    /// file content independently of bucket_build `read_file`).
    #[tokio::test]
