...
impl SourceFilter {
    ...
    ///
    /// bucket.com conversations carry `source == "conversation"` and live remotely,
...
pub(crate) fn capture_picker_selection(
    ...
    content_results: Option<&[bucket_agent_core::extensions::session_search::SearchSessionHit]>,
    state: &PickerState,
    query: &str,
    grouped: bool,
...
pub(crate) fn build_content_entry_data(
    hits: &[bucket_agent_core::extensions::session_search::SearchSessionHit],
    entries_data: &[SessionPickerEntry],
    filtered_indices: &[usize],
    state: &PickerState,
    content_start: usize,
...
mod tests {
    ...
    fn source_filter_matches() {
        ...
        // bucket.com conversations are remote: visible under All + Remote, not Local.
