//! BucketNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// BucketNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_bucketnight_theme() {
        let theme = Theme::bucketnight();
