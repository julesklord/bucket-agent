...
//!
//! The official `bucket-agent-sdk` lets a host define in-process tools (`@tool` /
...
use bucket_mcp::acp_transport::AcpReverseInvoker;
use bucket_mcp::servers::AcpServerEntry;
use bucket_mcp::wire;
