...
//!
//! These types support the feedback collection system for Bucket sessions.
//! The agent (bucket-agent-core) uses heuristics to determine when to request feedback,
...
pub struct FeedbackSubmission {
    ...
    /// Shell (bucket-agent-core) version
    #[serde(skip_serializing_if = "Option::is_none")]
...
fn default_tier1_prompt() -> String {
    "You've been using Bucket Code productively! Would you mind sharing quick feedback?".to_string()
}
