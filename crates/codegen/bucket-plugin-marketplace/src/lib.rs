...
pub const OFFICIAL_SOURCE_GIT_URL: &str = "https://github.com/bucket-org/plugin-marketplace.git";
...
pub fn is_official_source_url(url: &str) -> bool {
    canonical_github_owner_repo(url).as_deref() == Some("bucket-org/plugin-marketplace")
}
...
mod tests {
    ...
    fn is_official_matches_canonical_https() {
        ...
        assert!(is_official_source_url(
            "https://github.com/bucket-org/plugin-marketplace"
        ));
    }
    ...
    fn is_official_matches_ssh_form() {
        ...
        assert!(is_official_source_url(
            "git@github.com:bucket-org/plugin-marketplace"
        ));
        assert!(is_official_source_url(
            "ssh://git@github.com/bucket-org/plugin-marketplace.git"
        ));
        assert!(is_official_source_url(
            "ssh://git@github.com/bucket-org/plugin-marketplace"
        ));
    }
    ...
    fn is_official_rejects_unrelated_urls() {
        ...
        assert!(!is_official_source_url(
            "https://github.com/bucket-org/some-other-repo.git"
        ));
        assert!(!is_official_source_url(""));
    }
    ...
    fn is_official_matches_noncanonical_forms() {
        ...
        assert!(is_official_source_url(
            "http://github.com/bucket-org/plugin-marketplace"
        ));
        assert!(is_official_source_url(
            "https://www.github.com/bucket-org/plugin-marketplace.git"
        ));
        assert!(is_official_source_url(
            "git@github.com:BUCKET-org/plugin-marketplace.git"
        ));
