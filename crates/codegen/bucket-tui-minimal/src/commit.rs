...
use bucket_tui::appearance::AppearanceConfig;
use bucket_tui::minimal_api;
use bucket_tui::render::Renderable;
use bucket_tui::scrollback::block::RenderBlock;
use bucket_tui::scrollback::blocks::ToolCallBlock;
use bucket_tui::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                bucket_tui::theme::cache::set_terminal_native_lock(false);
            }
        }
