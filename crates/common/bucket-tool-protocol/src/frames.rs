...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `bucket-tool-runtime`. Sampler-side wire
...
/// `bucket_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<bucket_tool_types::ToolDescription>,
}
