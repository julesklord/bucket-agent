...
Terminal UI (TUI) for Bucket Build. Provides the interactive full-screen interface
...
- [Hook Examples](../bucket-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`bucket-hooks`)](../bucket-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`bucket-plugin-marketplace`)](../bucket-plugin-marketplace/) — marketplace source loading, scanning, and install
