...
//! Dark themes (BucketNight, TokyoNight) share `bucket-night.tmTheme`;
//! BucketDay uses `bucket-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use bucket_markdown::Syntect;

use crate::theme::ThemeKind;

static SYNTECT_BUCKETNIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_TOKYONIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_BUCKETDAY: OnceLock<Syntect> = OnceLock::new();
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_BUCKETNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/bucket-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::BucketDay => SYNTECT_BUCKETDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/bucket-day.tmTheme"))),
    }
}
