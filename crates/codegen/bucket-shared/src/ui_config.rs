...
pub struct UiConfig {
    ...
    /// connect time (CLI `--hunk-tracker-mode` / `BUCKET_HUNK_TRACKER` override
    ...
    /// Speech-to-text language preference for voice dictation. A Bucket STT
...
impl Default for UiConfig {
    fn default() -> Self {
        Self {
            ...
            theme: None,
            fork_secondary_model: bucket_models::default_model().to_string(),
            yolo: false,
            ui_theme: None,
            compact_mode: false,
            simple_mode: None,
