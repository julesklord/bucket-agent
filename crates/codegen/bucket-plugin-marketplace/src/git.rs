...
//! Cache root: `~/.bucket/marketplace-cache/<url-hash>/`
...
pub fn default_cache_root() -> PathBuf {
    bucket_config::bucket_home().join("marketplace-cache")
}
...
mod tests {
    ...
    fn cache_hash_is_deterministic() {
        let url = "https://github.com/bucket-org/bucket-plugin-marketplace.git";
    ...
    #[test]
    fn default_cache_root_under_bucket() {
