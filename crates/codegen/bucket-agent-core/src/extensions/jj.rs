//! Jujutsu extension handlers — delegates to [`bucket_workspace::session::jj`].

use agent_client_protocol as acp;

use super::{Empty, ExtResult, to_ext_response, to_ext_response_partial};
use bucket_workspace::session::git::{CommitData, StageData};
use bucket_workspace::session::jj;
