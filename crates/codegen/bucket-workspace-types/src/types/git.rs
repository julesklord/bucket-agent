...
//! `bucket_agent_core::session::git` and `bucket_agent_core::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `bucket_agent_core::session::git::VcsKind`.
