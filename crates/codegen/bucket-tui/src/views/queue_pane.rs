...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. BucketNight's dark band leaking into BucketDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default BucketNight, dark) after the user switches —
        // painting a dark band on a light BucketDay canvas.
