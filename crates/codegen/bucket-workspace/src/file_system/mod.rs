...
// its wire types live in `bucket_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use bucket_workspace_types::rpc::fs::FsReadEncoding;
...
pub use bucket_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
