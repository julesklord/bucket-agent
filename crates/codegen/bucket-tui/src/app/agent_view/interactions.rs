...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use bucket_tools::implementations::bucket_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        bucket_telemetry::session_ctx::log_event(bucket_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            bucket_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
...
mod question_no_freeform_tests {
    ...
    //! the SuperBucket upsell. Regression tests for the bug where clicking
    ...
    fn upsell_question() -> Question {
        ...
        Question {
            ...
            options: vec![
                opt("Upgrade to SuperBucket", "For everyday coding"),
                opt("Upgrade to SuperBucket Heavy", "Highest usage limits"),
            ],
