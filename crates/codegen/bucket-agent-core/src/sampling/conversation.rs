...
//!
//! The canonical types now live in `bucket_sampling_types::conversation`.
//! This module re-exports them and adds bucket-shell-specific types
//! (`ConversationRequestTrace`) that depend on internal crate types.

// Re-export everything from the standalone crate.
pub use bucket_sampling_types::conversation::*;

// ============================================================================
// bucket-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `bucket-agent-core` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in bucket-sampling-types crate.
