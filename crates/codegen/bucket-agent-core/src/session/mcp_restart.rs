...
//! window containing a [`bucket_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`bucket_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`bucket_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`bucket_mcp::servers::ClientStateKind::Empty`]
...
use bucket_mcp::servers::{McpClientEventKind, McpServerName};
