//! Retry utilities — re-exported from `bucket-tools`.
//!
//! The canonical implementation now lives in `bucket_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use bucket_tools::retry::BackoffConfig as RetryConfig;
pub use bucket_tools::retry::{BackoffConfig, execute_with_backoff};
