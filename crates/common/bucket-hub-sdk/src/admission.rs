...
/// Numeric JSON-RPC code for overload rejection (`bucket-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "BUCKET_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `BUCKET_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
