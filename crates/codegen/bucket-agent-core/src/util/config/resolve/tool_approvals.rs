...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "BUCKET_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`BUCKET_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `BUCKET_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
