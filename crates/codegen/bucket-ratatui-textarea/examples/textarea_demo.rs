...
//!
//! Run with: cargo run -p bucket-ratatui-textarea --example textarea_demo
//!
...
use bucket_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use bucket_ratatui_textarea::{
