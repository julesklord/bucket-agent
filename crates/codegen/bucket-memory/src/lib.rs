...
//! Bucket to persist important information across sessions. Memory files are
//! stored under `~/.bucket/memory/` with workspace-scoped subdirectories
...
//! `BUCKET_MEMORY=1` environment variable. When disabled, this crate
