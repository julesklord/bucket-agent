...
//! Run:
//! ```bash
//! cargo test -p bucket-tools --test path_suggestions_production
//! ```

use std::path::PathBuf;
use tempfile::TempDir;
use bucket_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &bucket_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_bucket_sessions_internal_path() {
