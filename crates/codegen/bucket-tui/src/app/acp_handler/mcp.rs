...
/// `BUCKET_MCP_PUSH_SERVER_STATUS=0` to disable.
pub(super) fn push_server_status_enabled() -> bool {
    use std::sync::OnceLock;
    static ENABLED: OnceLock<bool> = OnceLock::new();
    *ENABLED.get_or_init(|| {
        bucket_agent_core::util::config::resolve_mcp_push_server_status(
...
/// `bucket-agent-core/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`bucket_agent_core::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`bucket_agent_core::extensions::mcp::McpServerStatusPayload`] +
/// [`bucket_agent_core::extensions::mcp::McpServerStatus`]) instead of
...
/// on config reload (`crates/codegen/bucket-agent-core/src/agent/mvp_agent.rs`
