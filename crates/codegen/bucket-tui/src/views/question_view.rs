...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<bucket_telemetry::events::CreditLimitChoice>,
    },
    /// SuperBucket upsell modal: the free-usage paywall (429 +
    ...
    /// `id`.
    FreeUsageUpsell {
        /// Telemetry source for `SuperBucketUpsellClicked` — distinguishes
        /// the paywall from the restricted-command upsell.
        source: bucket_telemetry::events::SuperBucketUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<bucket_agent_core::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    /// questions (e.g. the SuperBucket upsell) have no freeform row, so
...
impl QuestionViewState {
    ...
    pub fn send_ext_response(
        &mut self,
        response: bucket_tools::implementations::bucket_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
...
mod tests {
    ...
    /// `no_freeform` questions (e.g. the SuperBucket upsell) have no "Other"
