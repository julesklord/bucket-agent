//! # bucket-hooks
//!
//! Runtime hook system for Bucket — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Bucket. Hooks are discovered
//! from dedicated directories (`~/.bucket/hooks/` and `<git-worktree-root>/.bucket/hooks/`),
...
//!     Some(Path::new("/home/user/.bucket/hooks")),
//!     Some(Path::new("/project/.bucket/hooks")),
//! );
//!
//! for err in &errors {
