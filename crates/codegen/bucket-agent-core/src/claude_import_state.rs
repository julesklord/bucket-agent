...
//
// State is persisted to `~/.bucket/claude_import_state.json`.
...
use bucket_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.bucket/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::bucket_home::bucket_home().join("claude_import_state.json")
}
