...
//! bucket-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn bucket_tools::implementations::lsp::LspBackend>>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = bucket_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
