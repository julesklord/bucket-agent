...
fn paint_peek_config_badge(
    ...
    // permission mode (the gate in bucket-agent-core), so `plan` alone is the
...
mod tests {
    ...
    fn render_peek_shows_model_and_auto_approve_on_bottom_border() {
        ...
        panel.model_name = Some("Bucket 4 Fast".to_string());
        panel.auto_approve = true;
        let bottom = badge_row(&panel, 6);
        assert!(
            bottom.contains("Bucket 4 Fast"),
        ...
        qpanel.model_name = Some("Bucket 4 Fast".to_string());
        let qbottom = badge_row(&qpanel, 8);
        assert!(
            qbottom.contains("Bucket 4 Fast"),
        ...
        plain.model_name = Some("Bucket 4 Fast".to_string());
        ...
        planp.model_name = Some("Bucket 4 Fast".to_string());
