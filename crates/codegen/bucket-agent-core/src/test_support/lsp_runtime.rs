...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-bucket-test"),
        ...
        parent_skills: None,
        parent_skills_config: bucket_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: bucket_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: bucket_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl bucket_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &bucket_tools::implementations::lsp::LspToolInput,
    ) -> bucket_tools::implementations::lsp::LspToolResult {
        bucket_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<bucket_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<bucket_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
