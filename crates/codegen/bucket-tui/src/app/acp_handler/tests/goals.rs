    ...
    fn goal_updated_ignores_unknown_json_fields_via_serde() {
        ...
        let raw_payload = serde_json::json!({
            ...
            "update": {
                ...
                "live_tokens_by_model": [["bucket-4", 6_000], ["bucket-3", 4_000]],
                "live_context_pct": 42,
                "live_turn_count": 7,
        ...
        let msg = AcpClientMessage::ExtNotification(bucket_acp::AcpArgs {
            request,
            response_tx: tx,
        });
        ...
        assert_eq!(
            ...
            vec![("bucket-4".to_owned(), 6_000), ("bucket-3".to_owned(), 4_000)],
