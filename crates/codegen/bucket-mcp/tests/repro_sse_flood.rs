...
//!
//! Run with: cargo test -p bucket-mcp --test repro_sse_flood -- --nocapture
...
use bucket_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use bucket_mcp::rmcp::ServiceExt;
use bucket_mcp::rmcp::transport::StreamableHttpClientTransport;
use bucket_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
