...
fn usage_rows() -> Vec<(String, bucket_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        bucket_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use bucket_tools::implementations::bucket_build::task::types::SubagentOutstandingReply;
...
> {
    use bucket_tools::implementations::bucket_build::task::types::SubagentEvent;
