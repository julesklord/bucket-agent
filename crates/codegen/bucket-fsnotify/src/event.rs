//! Public event types — the wire contract for `bucket-fsnotify`.
//!
...
//! translator (in `bucket-workspace`) maps these to
...
/// Aligned with `bucket_workspace_types::FsEventKind` (identity map at
