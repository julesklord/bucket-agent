...
//!
//! ```text
//! cargo bench -p bucket-tui --bench edit_highlight
//! cargo bench -p bucket-tui --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use bucket_tui::diff::{DiffHunk, DiffLine};
use bucket_tui::scrollback::blocks::tool::{
...
use bucket_tui::syntax::{Syntect, get_syntect};
