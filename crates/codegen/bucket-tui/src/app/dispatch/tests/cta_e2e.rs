    ...
    let response = bucket_hooks_plugins_types::MarketplaceListResponse {
        sources: vec![
            ...
            bucket_hooks_plugins_types::MarketplaceScanResult {
                ...
                source_kind: "git".into(),
                source_url_or_path: "git@github.com:bucket-org/plugin-marketplace.git".into(),
...
fn cta_install_error_category_maps_outcome() {
    use bucket_hooks_plugins_types::OutcomeStatus;
    assert_eq!(
...
mod cta_e2e {
    ...
    fn figma_candidate() -> bucket_hooks_plugins_types::MarketplacePluginEntry {
        let mut entry = cta_entry("figma", "not_installed");
    ...
    fn happy_path_with_auth_handoff() {
        ...
        let servers = vec![
            cta_mcp_server("bucket_com_managed", None, McpServerDisplayStatus::Ready),
    ...
    fn dismissed_plugin_suppressed_on_next_recompute() {
        ...
        let dismissed = bucket_agent_core::config::dismissed_plugin_ctas_in_file(&config_path);
        let matched =
        ...
        bucket_agent_core::config::add_dismissed_plugin_cta_to_file("figma", &config_path)
