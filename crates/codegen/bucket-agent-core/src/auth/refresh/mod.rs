...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<BucketAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: BucketAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, BucketAuth, BucketComConfig};
