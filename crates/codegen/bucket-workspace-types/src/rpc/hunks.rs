...
/// Wire-safe hunk action enum. Maps to `bucket_hunk_tracker::types::HunkAction`
...
// =========================================================================
// Request types whose responses reference `bucket_hunk_tracker` types (which pull
...
// =========================================================================
// Wire mirrors of `bucket_hunk_tracker` response types
// =========================================================================

/// Wire mirror of `bucket_hunk_tracker::types::Hunk` (the `selected` field is
...
/// Wire mirror of `bucket_hunk_tracker::types::HunkLineInfo`.
...
/// Wire mirror of `bucket_hunk_tracker::types::HunkSource`.
///
...
/// Wire mirror of `bucket_hunk_tracker::types::FileContentStatus`.
///
...
/// Wire mirror of `bucket_hunk_tracker::types::FileContentView`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `bucket_hunk_tracker::types::FileContentEntry`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `bucket_hunk_tracker::types::SessionStats`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `bucket_hunk_tracker::types::TurnSummary`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `bucket_hunk_tracker::types::SessionSummary`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
