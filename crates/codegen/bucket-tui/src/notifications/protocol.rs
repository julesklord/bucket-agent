...
pub enum NotificationProtocol {
    ...
    Osc9,
    /// Kitty: `\x1b]99;i=bucket;{message}\x1b\\`
    Osc99,
...
pub fn select_protocol(ctx: &TerminalContext) -> NotificationProtocol {
    ...
    match ctx.brand {
        ...
        TerminalName::BucketDesktop => NotificationProtocol::None,
...
pub fn emit_notification(
    ...
    let sequence: Cow<'_, str> = match protocol {
        ...
        NotificationProtocol::Osc99 => format!("\x1b]99;i=bucket;{body} \u{b7} {title}\x1b\\").into(),
        NotificationProtocol::Osc777 => format!("\x1b]777;notify;Bucket;{body}\x1b\\").into(),
...
mod tests {
    ...
    #[test]
    fn select_bucket_desktop_uses_none() {
        assert_eq!(
            select_protocol(&ctx_with_brand(TerminalName::BucketDesktop)),
    ...
    fn emit_none_is_noop() {
        let ctx = ctx_with_brand(TerminalName::BucketDesktop);
