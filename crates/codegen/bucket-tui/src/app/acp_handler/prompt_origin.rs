...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    bucket_agent_core::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        bucket_agent_core::session::PromptOrigin::from_prompt_id(prompt_id),
        bucket_agent_core::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        bucket_agent_core::session::PromptOrigin::from_prompt_id(prompt_id),
        bucket_agent_core::session::PromptOrigin::TaskCompleted { .. }
            | bucket_agent_core::session::PromptOrigin::SubagentCompleted { .. }
            | bucket_agent_core::session::PromptOrigin::NotificationDrain
    )
}
