...
crate::register_resource!("bucket_build", "ListDir", ListDirParams);
...
impl bucket_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(bucket_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
